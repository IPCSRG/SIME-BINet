...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--gan_mode', type=str, default='nogan', help='the type of GAN objective. [vanilla| lsgan | wgangp | hinge | nogan]. vanilla GAN loss is the cross-entropy objective used in the original GAN paper.')
